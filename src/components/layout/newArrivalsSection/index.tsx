...
import PlantCatalogCards from '@/components/elements/plantCatalogCards.tsx/plantHomeCatalogCards';
import { PlantsReponse } from '@/types/plants.types';
import Carousel from '@/components/elements/carousals/PlantCatalogCarousel';
